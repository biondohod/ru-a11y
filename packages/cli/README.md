...
- summary-блок с ключевыми метриками;
- таблицу нарушений (URL, origin, severity, principle, source, ссылки на ГОСТ/№102, рекомендация);
- базовое форматирование для быстрого просмотра без доп. инструментов.
